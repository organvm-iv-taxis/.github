...
> *τάξις — arrangement, order, governance*

**Governance and orchestration across the eight-organ system**

</div>

---

Cross-organ routing, governance, promotion automation, system coordination, dependency management

## Repositories

<!-- This section will be populated after repos are deployed to this org. -->
<!-- Use: gh repo list organvm-iv-taxis --json name,description --template '...' -->
...
<sub>ORGAN IV: Taxis &mdash; part of the eight-organ creative-institutional system</sub>
